...
function refreshCountDown () {
    ...
    if ( difference <= 0 ) {
        document.querySelector('.title-countdown').innerText = "C'est le grand jour !!!"
        document.querySelector('.title-countdown').style.color = "#fff"
        document.querySelectorAll('.countdown-card').forEach(index => {
