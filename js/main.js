      ...
      Array(JSON.parse(xhr.response))[0].forEach((child) => {
           ...
           <div class="container_top">
            ...
            <div class="wrapper">
                <div class="clash-card barbarian">
                    ...
                    <div class="clash-card__level clash-card__level--barbarian" style="color:blue;font-weight:blod;">${
                      child["0"]
                    }</div>
                    <div class="clash-card__unit-name">Etudian ${child[3]}</div>
        ...
        <div class="container_bottom">
            ...
            <div class="wrapper">
                <div class="clash-card barbarian">
                    <div class="clash-card__image clash-card__image--barbarian">
                        <img src="../assets/def.jpg" alt="barbarian" />
                    </div>
